...
toJoin = LOAD '/category_partitions/part-r-00004' USING PigStorage('\t') AS (category:chararray, asin:chararray);
...
STORE top_10_items_first INTO '/pig_temp/category-5' USING PigStorage();
